...
const sidebarLinks = [
  {
    href: "/dashboard/gatekeeper",
    label: "Dashboard",
    icon: LayoutDashboard,
  },
  {
    href: "/dashboard/gatekeeper/scan",
    label: "Scan QR",
    icon: Scan,
  },
  {
    href: "/dashboard/gatekeeper/logs",
    label: "Today's Log",
    icon: ClipboardList,
  },
]
...
export default function GatekeeperLayout({
  ...
  if (!session || session.user.role !== "gatekeeper") {
    redirect("/login")
  }
        ...
        <div className="h-full flex flex-col p-4 pt-6">
          <div className="flex items-center gap-3 mb-6 px-2">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">Gatekeeper</p>
            </div>
          </div>
